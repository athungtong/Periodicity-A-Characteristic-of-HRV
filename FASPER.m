...
function [WK1 WK2 JMAX PROB]=FASPER(X,Y,HIFAC)
if nargin <3
...
NOUT=1/2*OFAC*HIFAC*N; %This is the variable that control the maximum frequency range
...
% We have found bug here. We have seen negative power at the end of the
% time series. What we gonna do here is removing all the negative power
WK1(WK2<0)=[]; 
WK2(WK2<0)=[];
end
